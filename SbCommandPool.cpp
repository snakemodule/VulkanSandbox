...
SbCommandPool::~SbCommandPool()
{
}

VkCommandBuffer SbCommandPool::beginSingleTimeCommands() {
...
void SbCommandPool::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
	...
	vkFreeCommandBuffers(logicalDevice.device, this->handle, 1, &commandBuffer);
}
...
void SbCommandPool::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void SbCommandPool::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void SbCommandPool::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
void SbCommandPool::transitionImageLayout(VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout, VkImageSubresourceRange subresourceRange) 
{
	VkCommandBuffer commandBuffer = beginSingleTimeCommands();
