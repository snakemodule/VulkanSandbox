...
struct AnimatedVertex {
	...
	AnimatedVertex(glm::vec3 posVec, glm::vec3 colorvec, glm::vec2 texCoordVec, glm::vec3 normalVec) {
		pos = posVec;
		color = colorvec;
	...
	static std::array<VkVertexInputBindingDescription, 1> getBindingDescriptions() {
		...
		bindingDescription[0].stride = sizeof(AnimatedVertex);
	...
	static std::array<VkVertexInputAttributeDescription, 6> getAttributeDescriptions() {
		...
		attributeDescriptions[2].offset = offsetof(AnimatedVertex, texCoord);
		...
		attributeDescriptions[4].offset = offsetof(AnimatedVertex, boneIndex);

		attributeDescriptions[5].binding = 0;
		attributeDescriptions[5].location = 5;
		attributeDescriptions[5].format = VK_FORMAT_R32G32B32A32_SFLOAT;
		attributeDescriptions[5].offset = offsetof(AnimatedVertex, animWeight);
	...
	bool operator==(const AnimatedVertex& other) const {
		return pos == other.pos && color == other.color && texCoord == other.texCoord 
			&& boneIndex == other.boneIndex && animWeight == other.animWeight;
	}
};