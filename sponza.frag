...
layout(binding = 1) uniform sampler2D _diffuse;
layout(binding = 2) uniform sampler2D _specular;
layout(binding = 3) uniform sampler2D _bump;
...
void main() 
{
	...
	outAlbedo.rgb = texture(_diffuse, fragTexCoord);
