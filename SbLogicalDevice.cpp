...
SbLogicalDevice::SbLogicalDevice(SbPhysicalDevice & physicalDevice)
	:physDevice(physicalDevice)
{
}

SbLogicalDevice::~SbLogicalDevice()
{
}

void SbLogicalDevice::createLogicalDevice(VkSurfaceKHR surface, bool validation, const std::vector<const char*> validationLayers)
{
